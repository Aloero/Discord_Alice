...
type Message struct {
	...
	Body []byte `protobuf:"bytes,1,opt,name=body,proto3" json:"body,omitempty"` // Используем bytes для отправки среза байтов
}
...
type Response struct {
	...
	Body string `protobuf:"bytes,1,opt,name=body,proto3" json:"body,omitempty"` // Используем string для получения строки в ответ
}
...
var file_stream_proto_rawDesc = []byte{
	...
	0x73, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x22, 0x1d, 0x0a, 0x07, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67,
	...
	0x04, 0x62, 0x6f, 0x64, 0x79, 0x32, 0x3a, 0x0a, 0x0d, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x53,
	0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x29, 0x0a, 0x04, 0x43, 0x68, 0x61, 0x74, 0x12, 0x0f,
	0x2e, 0x73, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x2e, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x1a,
	0x10, 0x2e, 0x73, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x2e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73,
...
var file_stream_proto_depIdxs = []int32{
	0, // 0: stream.StreamService.Chat:input_type -> stream.Message
	1, // 1: stream.StreamService.Chat:output_type -> stream.Response
